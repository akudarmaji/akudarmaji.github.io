...
class Arabiyah extends Alquran{
  ...
  getTemplate() {
    ...
    this.arab.forEach((e, i) => {
      ...
      <button class="btn-details border border-teal-300 absolute shadow-xl h-6  -left-1 -top-3 rounded-md bg-teal-100 bg-opacity-40 px-1  text-sm text-teal-500 font-extralight" data-id="${i}">🔄</button>
